...
Drives parallax with the [Web Animations API](https://parallax-controller.damnthat.tv/docs/v2/intro) for scroll-linked animations. If you're upgrading from v3, see the [migration guide](/docs/v4/migration-guides/v3-migration-guide).
