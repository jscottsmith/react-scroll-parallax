...
You can provide [CSS timing functions](/docs/usage/parallax-props#timing-functions) or [cubic-bezier curve params](/docs/usage/parallax-props#cubic-bezier-easing-function) to the `useParallax` hook or `<Parallax />` component.
