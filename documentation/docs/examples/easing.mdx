...
You can provide [CSS timing functions](/docs/v4/usage/parallax-props#easing) or `cubic-bezier(...)` curves to the `useParallax` hook or `<Parallax />` component.
...
Define a custom cubic-bezier curve by providing the 4 params as a CSS `cubic-bezier(...)` string.
