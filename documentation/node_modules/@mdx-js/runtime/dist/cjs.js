...
var bubleJsxOnly = require('buble-jsx-only');
...
var index = (function (_ref) {
  ...
  var jsx = mdx__default['default'].sync(children, {
  ...
  try {
    code = bubleJsxOnly.transform(jsx, {
  ...
  return fn.apply(void 0, [{}, React__default['default']].concat(_toConsumableArray(values)));
});
