  ...
  _createClass(JsonFunctionValue, [{
    ...
    value: function render() {
      ...
      if (editEnabled && !resultOnlyResult) {
        var textareaElement = textareaElementGenerator(_inputUsageTypes.default.VALUE, comeFromKeyPath, deep, name, originalValue, dataType);
        ...
        var textareaElementLayout = /*#__PURE__*/_react.default.cloneElement(textareaElement, {
          ref: this.refInput,
...
var _default = JsonFunctionValue;
