...
const VERSION = '6.0.0';
export const Loading = () => /*#__PURE__*/React.createElement(PureReleaseNotesScreen, _extends({
  didHitMaxWaitTime: false,
  isLoaded: false,
  version: VERSION
}, actions));
Loading.displayName = "Loading";
export const DidHitMaxWaitTime = () => /*#__PURE__*/React.createElement(PureReleaseNotesScreen, _extends({
