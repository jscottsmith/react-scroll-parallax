...
export const waitForRender = () => waitForEvents([Events.STORY_RENDERED, Events.DOCS_RENDERED, Events.STORY_THREW_EXCEPTION, Events.STORY_ERRORED, Events.STORY_MISSING]);
export const waitForRenderPhase = phase => waitForEvents([Events.STORY_RENDER_PHASE_CHANGED], ({
  newPhase
