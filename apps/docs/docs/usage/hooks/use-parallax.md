...
| **controller** | The [`ParallaxController`](/docs/scroll-parallax/api/parallax-controller/) instance.                 |
| **element**    | The `Element` created by the [`ParallaxController`](/docs/scroll-parallax/api/parallax-controller/). |
